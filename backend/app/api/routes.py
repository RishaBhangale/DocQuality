...
async def get_pipeline_status(
    ...
    """
    from app.models.db_models import Evaluation, IngestionEvent
...
async def apply_correction(
    ...
    """
    from app.models.db_models import CorrectionProposal
...
async def download_fixed_document(
    ...
    from app.models.db_models import Evaluation, CorrectionProposal
