...
// Maps the deterministic issue types to their corresponding core metrics
const getMetricForIssueType = (issueType: string): string => {
            ...
            <tbody>
              {issues.map((issue, index) => (
                <tr key={index} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 px-3 sm:px-4 text-xs sm:text-sm text-[#1E3A8A] font-medium break-words">{getMetricForIssueType(issue.issueType)}</td>
